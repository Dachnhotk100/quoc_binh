...
# 1,2,3. Bar chart cơ bản + tiêu đề + màu khác nhau
...
barplot(scores,
        names.arg = subjects,
        col = colors,
        main = "Điểm thi của bạn (Horizontal)",
        horiz = TRUE)
...
# Histogram 10 bins + tiêu đề + tô màu
hist(exam_scores,
     breaks = 10,
     col = "blue",
...
boxplot(Petal.Length ~ Species,
        ...
        ylab = "Petal Length")
#Nhận xét
#Petal dài nhất: virginica
#Độ biến thiên lớn nhất: virginica
#Outliers: có, thường thấy ở versicolor hoặc virginica
# ------------------------------------------------------------------------------
...
# 2. Vẽ line plot cho từng sản phẩm qua 4 # Dữ liệu
